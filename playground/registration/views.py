...
class ProfileUpdate(UpdateView):
    ...
    def get_object(self):
        # Recupera el objeto a editar
        #!  con get Va a dar error porque no existe todavía el Profile
        profile,create = Profile.objects.get_or_create(user=self.request.user) #* Esto devuelve una tupla
        return profile
...
class EmailUpdate(UpdateView):
    ...
    def get_object(self):
        # Devolvemos el usuario al que pertenece el nuevo email.
